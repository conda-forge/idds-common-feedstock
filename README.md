...
Summary: intelligent Distributed Dispatch and Scheduling (iDDS) Package
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/idds-common-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/idds-common-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add idds-common
# for installing globally
pixi global install idds-common
```
...
It is possible to list all of the versions of `idds-common` available on your platform:
...
```
pixi search idds-common --channel conda-forge
```
