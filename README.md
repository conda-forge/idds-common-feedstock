...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/idds-common-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13426&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/idds-common-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `idds-common` can be installed with:

```
conda install idds-common
```

It is possible to list all of the versions of `idds-common` available on your platform with:
